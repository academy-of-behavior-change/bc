...
```{r abcd-specificatie, echo=FALSE}
...
![De ABCD voor het XTC voorbeeld](abcd_specs_dutch_xtc.png){ width=100% }
...
Kok, G., Gottlieb, N. H., Peters, G.-J. Y., Mullen, P. D., Parcel, G. S., Ruiter, R. A. C., … Bartholomew, L. K. (2016). A taxonomy of behavior change methods: an Intervention Mapping approach. *Health Psychology Review, 10*, 297–312. \doi{10.1080/17437199.2015.1077155}
